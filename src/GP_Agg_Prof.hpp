...
#ifndef SRC_GP_AGG_PROF_HPP_
#define SRC_GP_AGG_PROF_HPP_
...
class GP_Agg_Prof : public GroupPredictor {
public:

	int groupPredType = AVG;

	GP_Agg_Prof(ExpSetting& expSet, int type);
